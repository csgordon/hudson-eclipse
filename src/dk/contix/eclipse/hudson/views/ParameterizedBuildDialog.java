...
@UIType public class ParameterizedBuildDialog extends Dialog {
	...
	@UIType private static class ParameterLabelProvider extends LabelProvider implements ITableLabelProvider {
	...
	@UIType private static class ParameterModifier implements ICellModifier {
